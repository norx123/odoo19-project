...
class HrPayrollSalaryAttachment(models.Model):
    """Model for managing Salary Attachments (deductions/additions) for employees.
    Named hr.payroll.salary.attachment to avoid conflict with Odoo built-in model."""
    _name = 'hr.payroll.salary.attachment'
    _description = 'Payroll Salary Attachment'
